  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="pt-20">
        {/* Header */}
        <section className="bg-gradient-to-br from-purple-600 to-violet-800 text-white py-16 relative overflow-hidden">
          {/* Animated Background Graphics */}
          <div className="absolute inset-0 pointer-events-none">
            {/* Large blur circles - purple theme */}
            <div className="absolute top-20 left-10 w-72 h-72 bg-white/6 rounded-full blur-xl animate-glow-pulse"></div>
            <div className="absolute top-40 right-20 w-96 h-96 bg-purple-300/12 rounded-full blur-lg animate-float-medium" style={{animationDelay: '2s'}}></div>
            <div className="absolute bottom-32 left-1/4 w-80 h-80 bg-violet-300/10 rounded-full blur-2xl animate-float-slow" style={{animationDelay: '1s'}}></div>
            ...
            <div className="absolute bottom-20 right-10 w-68 h-68 bg-fuchsia-300/8 rounded-full blur-xl animate-float-medium" style={{animationDelay: '4s'}}></div>
            
            {/* Additional massive graphics */}
            <div className="absolute top-10 right-1/4 w-88 h-88 bg-indigo-300/9 rounded-full blur-3xl animate-float-slow" style={{animationDelay: '6s'}}></div>
            <div className="absolute bottom-10 left-1/3 w-84 h-84 bg-purple-300/8 rounded-full blur-2xl animate-glow-pulse" style={{animationDelay: '7s'}}></div>
            <div className="absolute top-1/2 left-20 w-76 h-76 bg-violet-300/10 rounded-full blur-xl animate-float-medium" style={{animationDelay: '8s'}}></div>
            <div className="absolute top-0 left-1/2 w-72 h-72 bg-lavender-300/7 rounded-full blur-3xl animate-float-slow" style={{animationDelay: '10s'}}></div>
            <div className="absolute bottom-0 right-1/2 w-88 h-88 bg-purple-300/6 rounded-full blur-2xl animate-glow-pulse" style={{animationDelay: '11s'}}></div>
            <div className="absolute top-2/3 left-0 w-64 h-64 bg-fuchsia-300/8 rounded-full blur-xl animate-float-medium" style={{animationDelay: '12s'}}></div>
            <div className="absolute top-1/4 right-0 w-80 h-80 bg-violet-300/7 rounded-full blur-3xl animate-float-slow" style={{animationDelay: '13s'}}></div>
            
            {/* Medium floating elements */}
            <div className="absolute top-32 left-1/2 w-48 h-48 bg-purple-300/6 rounded-full blur-lg animate-glow-pulse" style={{animationDelay: '14s'}}></div>
            <div className="absolute bottom-48 right-1/4 w-56 h-56 bg-indigo-300/8 rounded-full blur-xl animate-float-medium" style={{animationDelay: '15s'}}></div>
            <div className="absolute top-3/4 left-3/4 w-44 h-44 bg-fuchsia-300/7 rounded-full blur-lg animate-float-slow" style={{animationDelay: '16s'}}></div>
            ...
            <div className="absolute top-1/2 right-16 w-24 h-24 border-2 border-purple-300/20 rounded-full animate-float-slow" style={{animationDelay: '5s'}}></div>
            <div className="absolute bottom-16 right-1/4 w-18 h-18 border-2 border-violet-300/30 rotate-45 animate-float-fast" style={{animationDelay: '3s'}}></div>
            <div className="absolute top-24 right-1/2 w-12 h-12 bg-fuchsia-300/25 rounded-full animate-glow-pulse" style={{animationDelay: '4s'}}></div>
            <div className="absolute bottom-1/3 left-1/2 w-20 h-20 border-2 border-indigo-300/25 rounded-full animate-float-medium" style={{animationDelay: '9s'}}></div>
            
            {/* Additional geometric patterns */}
            <div className="absolute top-48 left-3/4 w-14 h-14 border border-purple-300/20 rotate-12 animate-float-fast" style={{animationDelay: '17s'}}></div>
            <div className="absolute bottom-56 left-20 w-10 h-10 bg-violet-300/25 rounded-full animate-glow-pulse" style={{animationDelay: '18s'}}></div>
            <div className="absolute top-80 right-1/3 w-16 h-16 border-2 border-fuchsia-300/25 animate-float-slow" style={{animationDelay: '19s'}}></div>
            <div className="absolute bottom-24 left-2/3 w-22 h-22 border border-indigo-300/30 rounded-full animate-float-medium" style={{animationDelay: '20s'}}></div>
            <div className="absolute top-12 left-12 w-8 h-8 bg-purple-300/30 rotate-45 animate-glow-pulse" style={{animationDelay: '21s'}}></div>
            <div className="absolute bottom-12 right-12 w-12 h-12 border-2 border-violet-300/20 rounded-full animate-float-fast" style={{animationDelay: '22s'}}></div>
          </div>
