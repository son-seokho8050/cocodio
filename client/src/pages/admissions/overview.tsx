      ...
      <main className="pt-20">
        ...
        <section className="hero-gradient text-white py-20 relative overflow-hidden">
          ...
          <div className="absolute inset-0 pointer-events-none">
            ...
            <div className="absolute top-40 right-20 w-24 h-24 bg-blue-300/10 rounded-full blur-lg animate-bounce" style={{animationDelay: '2s', animationDuration: '4s'}}></div>
            <div className="absolute bottom-32 left-1/4 w-40 h-40 bg-purple-300/8 rounded-full blur-2xl animate-pulse" style={{animationDelay: '1s', animationDuration: '6s'}}></div>
            <div className="absolute top-1/3 right-1/3 w-16 h-16 bg-white/8 rounded-full blur-md animate-ping" style={{animationDelay: '3s', animationDuration: '8s'}}></div>
            <div className="absolute bottom-20 right-10 w-28 h-28 bg-cyan-300/6 rounded-full blur-xl animate-bounce" style={{animationDelay: '4s', animationDuration: '5s'}}></div>
            
            {/* Floating geometric shapes */}
            <div className="absolute top-16 left-1/3 w-6 h-6 border border-white/20 rotate-45 animate-spin" style={{animationDuration: '12s'}}></div>
            <div className="absolute bottom-40 left-16 w-4 h-4 bg-white/15 rotate-12 animate-pulse" style={{animationDelay: '2s'}}></div>
            <div className="absolute top-1/2 right-16 w-8 h-8 border-2 border-blue-300/15 rounded-full animate-ping" style={{animationDelay: '5s', animationDuration: '7s'}}></div>
          </div>
