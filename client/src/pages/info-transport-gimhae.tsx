...
export default function InfoTransportGimhae() {
  return (
    <div className="min-h-screen bg-gray-50 pt-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-900 mb-4">안전귀가 차량운행 - 김해코코</h1>
                ...
                <div className="bg-gradient-to-br from-yellow-50 to-amber-50 rounded-lg p-6 flex-1 mb-4">
                  ...
                  <div className="space-y-4 text-sm text-gray-700">
                    <div>
                      ...
                      <p className="text-xs text-gray-500 mt-1">김해 및 주변 지역</p>
                    </div>
                    <div>
