      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="mb-4 text-sm leading-relaxed" style={{ color: 'rgba(255,255,255,0.42)' }}>
            ...
            <div className="flex space-x-3">
              {[
                ...
                <a key={label} href={href} target="_blank" rel="noopener noreferrer" aria-label={label}
                  ...
                  onMouseEnter={e => { e.currentTarget.style.color = '#A78BFA'; e.currentTarget.style.background = 'rgba(139,92,246,0.15)'; e.currentTarget.style.borderColor = 'rgba(139,92,246,0.35)'; }}
                  onMouseLeave={e => { e.currentTarget.style.color = 'rgba(255,255,255,0.40)'; e.currentTarget.style.background = 'rgba(255,255,255,0.07)'; e.currentTarget.style.borderColor = 'rgba(255,255,255,0.12)'; }}
                >
          ...
          <div>
            <h4 className="text-sm font-bold mb-4" style={{ color: 'rgba(255,255,255,0.65)' }}>빠른 링크</h4>
          ...
          <div>
            <h4 className="text-sm font-bold mb-4" style={{ color: 'rgba(255,255,255,0.65)' }}>문의 정보</h4>
        ...
        <div style={{ borderTop: '1px solid rgba(255,255,255,0.07)', paddingTop: '1.5rem' }}>
          <div className="text-center text-sm mb-3" style={{ color: 'rgba(255,255,255,0.22)' }}>
