...
export default function InfoSection() {
  return (
    <section id="info" className="py-24" style={{ background: 'rgba(255,255,255,0.55)', backdropFilter: 'blur(24px) saturate(1.4)', WebkitBackdropFilter: 'blur(24px) saturate(1.4)', borderTop: '1px solid rgba(255,255,255,0.55)', borderBottom: '1px solid rgba(255,255,255,0.55)' }}>
